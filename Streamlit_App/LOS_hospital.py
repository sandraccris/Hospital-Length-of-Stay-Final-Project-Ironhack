...
if menu == "Home":
    ...
    st.image("Streamlit_App/image.jpg", width=400, use_column_width=True)
    ...
    st.image("Streamlit_App/imag2.jpg", width=200, use_column_width=True)
    st.markdown("<p style='margin-top: 20px;'></p>", unsafe_allow_html=True)
    st.markdown("<p style='margin-top: 20px;'></p>", unsafe_allow_html=True)
...
if menu == "Useful Recommendations":
    st.image("Streamlit_App/imag3.jpg", width=200, use_column_width=True)
    st.markdown("<p style='margin-top: 20px;'></p>", unsafe_allow_html=True)
    st.markdown("<p style='margin-top: 20px;'></p>", unsafe_allow_html=True)
...
if menu == "About Me":
    st.image("Streamlit_App/imag5.jpg", width=50, use_column_width=True)
...
st.sidebar.image("Streamlit_App/imaggif.gif", width=250)
